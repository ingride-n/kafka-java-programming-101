...
kafka-topics.sh
```
3. Add the Kafka CLI commands to your `PATH` variable. Append the following line at the end of your `~/.bash_profile`. To get an accurate path to your kafka `bin` directory, execute `pwd` from that location.
```
